...
| Library                             | Framework                      |
| ----------------------------------- | ------------------------------ |
| In our program, our code calls the `library`      | While in a framework, the framework calls our code      |
| We control the flow of the program. | Framework controls the flow        |
