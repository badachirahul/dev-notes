...
* `Configuration means defining settings that tell the application how it should run, like server port, database connection, and other custom properties.`
...
| Library                             | Framework                      |
| ----------------------------------- | ------------------------------ |
| In our program, our code calls the `library`      | While in framework, framework calls our code      |
...
* `application.properties is a configuration file used to store application settings like server port, database configuration, and custom properties.`
